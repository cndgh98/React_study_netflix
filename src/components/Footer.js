      ...
      <FooterContent>
        <FooterLinkContainer>
          ...
          <FooterLinkContent>
            ...
            <FooterLink href="https://help.netflix.com/ko/contactus">문의사항</FooterLink>
            <FooterLink href="https://help.netflix.com/ko/legal/notices">법적고지</FooterLink>
          </FooterLinkContent>
        </FooterLinkContainer>
        <FooterDescContainer>
...
const FooterContainer = styled.div`
  ...
  align-items: center;
  padding: 40px 0px;
  border-top: 1px solid rgb(125, 25, 25);
  width: 100%;
  position: relative;
  z-index: 100;
...
`;
const FooterDescRights = styled.h3`
  color: red;
